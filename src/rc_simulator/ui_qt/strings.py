...
class UiStrings:
    ...
    window_minimize_tooltip: str = "Minimize window."
    window_maximize_tooltip: str = "Maximize window."
    window_restore_tooltip: str = "Restore window."
    window_close_tooltip: str = "Close window."
    window_minimize_glyph: str = "–"
    window_maximize_glyph: str = "□"
    window_restore_glyph: str = "❐"
    window_close_glyph: str = "✕"

    # Log panel controls
    log_collapse_glyph_expanded: str = "▾"
    log_collapse_glyph_collapsed: str = "▸"

    # Settings (Layout D)
    settings_title: str = "Settings"
    settings_section_display: str = "Display"
    settings_section_status: str = "Current status"
    ...
    settings_start_fullscreen: str = "Start in fullscreen"
    ...
    settings_tooltip_start_fullscreen: str = "Open in fullscreen (hides the OS taskbar if supported)."
    ...
    # Settings: current status fields
    settings_status_layout: str = "Layout"
    settings_status_phase: str = "State"
    settings_status_fullscreen: str = "Fullscreen"
    settings_status_platform: str = "Platform"
    settings_value_yes: str = "Yes"
    settings_value_no: str = "No"
    settings_platform_wayland: str = "Wayland/WSLg"
    settings_platform_x11: str = "X11/Other"
    settings_layout_a: str = "Dashboard"
    settings_layout_b: str = "Drive"
    settings_layout_c: str = "Panels"
    settings_layout_d: str = "Settings"

    settings_copy_diag_accessible_name: str = "Copy diagnostics"
    settings_copy_diag_accessible_desc: str = "Copy system and configuration details to the clipboard"
    settings_apply_accessible_name: str = "Apply settings"
    settings_apply_accessible_desc: str = "Save settings and apply them to the application"

    settings_tooltip_start_fullscreen_disabled_wayland: str = (
        "Not available on Wayland/WSLg due to unreliable fullscreen transitions."
    )
    ...
    toast_scan_started: str = "Scanning for cars…"
    toast_scan_cancelling: str = "Cancelling scan…"
    toast_scan_cancelled: str = "Scan cancelled."
    toast_scan_found: str = "{count} cars found."
    toast_scan_none: str = "No cars found."
    ...
    log_empty_placeholder: str = "No events yet. Scans, connections, and errors will appear here."
    log_toggle_accessible_name: str = "Toggle system log"
    log_toggle_accessible_desc: str = "Collapse or expand the system log panel"
    log_pause: str = "Pause"
...
UI_STRINGS_IT = UiStrings(
    ...
    window_minimize_tooltip="Minimizza finestra.",
    window_maximize_tooltip="Massimizza finestra.",
    window_restore_tooltip="Ripristina finestra.",
    window_close_tooltip="Chiudi finestra.",
    window_minimize_glyph="–",
    window_maximize_glyph="□",
    window_restore_glyph="❐",
    window_close_glyph="✕",
    log_collapse_glyph_expanded="▾",
    log_collapse_glyph_collapsed="▸",
    settings_title="Impostazioni",
    settings_section_display="Schermo",
    settings_section_status="Stato attuale",
    ...
    settings_start_fullscreen="Avvia a schermo intero",
    ...
    settings_tooltip_start_fullscreen="Apri a schermo intero (nasconde la barra del sistema se supportato).",
    ...
    settings_status_layout="Layout",
    settings_status_phase="Stato",
    settings_status_fullscreen="Schermo intero",
    settings_status_platform="Piattaforma",
    settings_value_yes="Si",
    settings_value_no="No",
    settings_platform_wayland="Wayland/WSLg",
    settings_platform_x11="X11/Altro",
    settings_layout_a="Dashboard",
    settings_layout_b="Guida",
    settings_layout_c="Pannelli",
    settings_layout_d="Impostazioni",
    settings_copy_diag_accessible_name="Copia diagnostica",
    settings_copy_diag_accessible_desc="Copia i dettagli di sistema e configurazione negli appunti",
    settings_apply_accessible_name="Applica impostazioni",
    settings_apply_accessible_desc="Salva le impostazioni e applicale all'applicazione",
    settings_tooltip_start_fullscreen_disabled_wayland=(
        "Non disponibile su Wayland/WSLg per transizioni a schermo intero non affidabili."
    ),
    ...
    toast_scan_started="Scansione auto…",
    toast_scan_cancelling="Annullamento scansione…",
    toast_scan_cancelled="Scansione annullata.",
    toast_scan_found="{count} auto trovate.",
    toast_scan_none="Nessuna auto trovata.",
    ...
    log_empty_placeholder="Nessun evento ancora. Scansioni, connessioni ed errori appariranno qui.",
    log_toggle_accessible_name="Mostra/nascondi log di sistema",
    log_toggle_accessible_desc="Comprimi o espandi il pannello del log di sistema",
    log_pause="Pausa",
    log_resume="Riprendi",
...
UI_STRINGS_ES = UiStrings(
    ...
    window_minimize_tooltip="Minimizar ventana.",
    window_maximize_tooltip="Maximizar ventana.",
    window_restore_tooltip="Restaurar ventana.",
    window_close_tooltip="Cerrar ventana.",
    window_minimize_glyph="–",
    window_maximize_glyph="□",
    window_restore_glyph="❐",
    window_close_glyph="✕",
    ...
    settings_section_status="Estado actual",
    ...
    settings_start_fullscreen="Iniciar en pantalla completa",
    ...
    settings_tooltip_start_fullscreen="Abrir en pantalla completa (oculta la barra del sistema si es compatible).",
    ...
    settings_status_layout="Layout",
    settings_status_phase="Estado",
    settings_status_fullscreen="Pantalla completa",
    settings_status_platform="Plataforma",
    settings_value_yes="Sí",
    settings_value_no="No",
    settings_platform_wayland="Wayland/WSLg",
    settings_platform_x11="X11/Otro",
    settings_layout_a="Panel",
    settings_layout_b="Conducir",
    settings_layout_c="Paneles",
    settings_layout_d="Ajustes",
    settings_copy_diag_accessible_name="Copiar diagnósticos",
    settings_copy_diag_accessible_desc="Copia detalles del sistema y la configuración al portapapeles",
    settings_apply_accessible_name="Aplicar ajustes",
    settings_apply_accessible_desc="Guarda los ajustes y los aplica a la aplicación",
    settings_tooltip_start_fullscreen_disabled_wayland=(
        "No disponible en Wayland/WSLg por transiciones de pantalla completa poco fiables."
    ),
    ...
    toast_scan_started="Buscando coches…",
    toast_scan_cancelling="Cancelando busqueda…",
    toast_scan_cancelled="Busqueda cancelada.",
    toast_scan_found="{count} coches encontrados.",
    toast_scan_none="No se encontraron coches.",
    ...
    log_empty_placeholder="Aún no hay eventos. Las búsquedas, conexiones y errores aparecerán aquí.",
    log_toggle_accessible_name="Mostrar/ocultar log del sistema",
    log_toggle_accessible_desc="Contraer o expandir el panel de logs del sistema",
    log_pause="Pausar",
    log_resume="Reanudar",
