...
Use this document to get help, report issues, and request features.
...
- Environment details (OS, runtime versions, relevant config)
...
For general questions, see `README.md` and the consolidated technical docs:
